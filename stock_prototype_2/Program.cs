...
class Stock
{
    ...
    private float[] recordPrice;    // 가격 기록
    private float[] recordWeight;   // 가중치(생성했던 gaussianNumber weight 기록)
    private float gaussianMean;    // gaussian dist. 의 평균
    private float gaussianStd;     // gaussian dist. 의 표준편차
    ...
    *///////////////////////////////////////////////////////////////////////
    ...
    public Stock(float initPrice, int recordLength)
    {
        this.price = initPrice; //입력받은 초기 가격
        this.recordPrice = new float[recordLength];    // 입력받은 recordLength만큼 기록을 남기고 RNN에 사용
        this.recordPrice[0] = this.price;
        this.recordWeight = new float[recordLength];// 입력받은 recordLength만큼 기록을 남기고 RNN에 사용
    ...
    {
        float newWeight = this.gaussianNum();
    ...
    public void updateByRNNonWeight()//아마도 코인 가격에 적합할듯
    {
        ...
        this.price = (float)(this.price + (this.RNN(recordWeight) + this.gaussianNum()) / 2 * this.price); 
    }

    private double RNN(float[] data)
    {
        return 0.0;
    }

    private float gaussianNum()
    {
        /*/////////////////////////////////////////////////////////////////////////
        ...
        return (float)(this.gaussianStd * (randStdNormal) + this.gaussianMean);
    }
    ...
    {
        this.gaussianMean = (float)mean;
    }

    public void setStd(double std)
    {
        this.gaussianStd = (float)std;
    }
}